...
const nextSlide = () =>
  (index_slide = index_slide + 1 === slides.length ? 0 : index_slide + 1);
const prevSlide = () =>
  (index_slide = index_slide - 1 < 0 ? slides.length - 1 : index_slide - 1);
// stop slide
document
...
products.forEach((e) => {
  ...
  document
    ...
    .insertAdjacentHTML("afterbegin", prod);
});
